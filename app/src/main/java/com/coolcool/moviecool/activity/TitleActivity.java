...
import com.coolcool.moviecool.test.BmobAdapter;

public class TitleActivity extends AppCompatActivity {
    public static final String TAG="TitleActivity";
    public static final String CRITERIA_SCROLL="TitleActivity.CRITERIA_SCROLL";
    public static final String CRITERIA_AREA="TitleActivity.CRITERIA_AREA";
    public static final String CRITERIA_GENRE="TitleActivity.CRITERIA_GENRE";
    public static final String CRITERIA_RELEASE_YEAR="TitleActivity.CRITERIA_RELEASE_YEAR";
    ...
    private void initView(){
        ...
        tvSelect = (TextView) findViewById(R.id.selectCategory);

        //listView的头布局，用来存放headerView视图的
        headerListAnimator = (ViewAnimator) inflater.inflate(R.layout.list_header_view,lvMovieList,false);
        ...
        headerFloatAnimator = (ViewAnimator) findViewById(R.id.headerFloatAnimator);
...
//        lvMovieList.setTranscriptMode(AbsListView.TRANSCRIPT_MODE_NORMAL);
    ...
    View headerView;
    ViewAnimator headerListAnimator;
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (adapter!=null){
                        if (adapter.getItemCount()>originPosition){
                            ...
                            Toast.makeText(TitleActivity.this,"已经是最后一项了",Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    AdapterView.OnItemClickListener mOnItemClickListener=new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent intent = new Intent(TitleActivity.this, DetailActivity.class);
    ...
    public interface CategoryListener{
        void onClickCategory(BmobAdapter adapter,int page);
    }
